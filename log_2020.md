...
**Notes** This chapter reviewed skimage tools for some different types of histogram equalization, resizing, and some morphology operations. I've already done a lot of the resizing stuff in OpenCV, but it is nice to learn the equivalent skimage tools. I'm especially glad to be exposed to these histogram equalization methods in this chapter.
