...
**Notes** I'm tyring to figure out some better ways to set element styles, I didn't realize the way I've been doing it sets the styles using the style keyword attribute within each html tag, instead of setting global styles. It is messy and repetitive. I want easy consistency, so tag styling isn't the way to do it. I think using global styles will also make it easier to translate the html from the file rendered by Bootsrap Studio into the template-style of Django's html. 
