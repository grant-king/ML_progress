...
**Today's Progress:** Started, abandoned DCP lesson 6. Started Software Development Processes and Methodologies course by University of Minnesota on Coursera.

**Notes:** It is time to abandon this Design of Computer Programs course. The instructor is continuing to prove that he is not going to be teaching the things that I expected to learn here. The hardest part of the course shouldn't be trying to understand code that seems like it is intentionally defying all conventions. These are simple ideas so far but the way he is presenting them makes everything so much harder than it has to be. I can't imagine who this class is for; you have to know all of the parts he is leaving out to be able to follow his train of thought. I hate to think how it will feel when I encounter material that isn't as familiar. I want to know how this course was planned or if this person is a regular educator. He seems like a nice and capable guy who thinks about things differently, just not someone who should be teaching everybody. I hope someone else has created a worthwhile replacement in the 8 years since this came out. 
