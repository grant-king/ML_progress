...
class Ship(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.angle = 0
        self.spritesheet = Spritesheet('carrot.png', 1, 2)
        
        self.size = [self.spritesheet.cell_width, self.spritesheet.cell_height]
        self.pristine_surface = pygame.Surface(self.size)
    ...
    def update_image(self):
        ...
        self.spritesheet.stamp_cell(self.pristine_surface, self.current_cell_idx, (0, 0, self.size[0], self.size[1]))
